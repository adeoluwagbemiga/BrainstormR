...
{
    public class MyEvalsFragment : Fragment, AdapterView.IOnItemClickListener
    {
        private MyEvaluationsList_Adapter _adapter;
        private Android.Support.V7.Widget.SearchView _searchView;

        public MyEvaluationsViewModel Vm
        {
            get
            {
                return App.Locator.MyEvaluations;
            }
        }
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            titlelabel.Text = "My Exams";

            var myebook_list = view.FindViewById<ListView>(Resource.Id.ebooks_listview);

            _adapter = new MyEvaluationsList_Adapter(this.Activity, Vm.MyEvaluationsList);
            Vm.LoadMyEvaluationsCommand.Execute(null);
        ...
        public void OnItemClick(AdapterView parent, View view, int position, long id)
        {
            ...
            Vm.OpenMyEvaluationDetailCommand.Execute(selecteditem);
        }
